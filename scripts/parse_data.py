...
#
# def boxPlotter(metricAssessListSampleLeft,
#                metricAssessListSampleRight,
#                metricTestListSampleLeft,
#                metricTestListSampleRight,
#                leftSubTitleText,
#                rightSubTitleText,
#                yAxisText,
#                xAxisText,
#                nameOfMetric,
#                leftDifferenceStats,
#                rightDifferenceStats,
#                filenameForCharts):
#     pass
#     maxHeight4Text = max(max(metricAssessListSampleLeft),
#         max(metricTestListSampleLeft),
#         max(metricAssessListSampleRight),
#         max(metricTestListSampleRight))
#     boxWidth = 0.5
#     if nameOfMetric == "Accuracy":
#         performanceMetric, units = "Error Reduction: ", "%"
#     else:
#         performanceMetric, units = "Time Savings: ", " Secs"
#     data1 = [metricAssessListSampleLeft, metricTestListSampleLeft]
#     data2 = [metricAssessListSampleRight, metricTestListSampleRight]
#     fig, ax = traceuse.subplots(figsize=(9, 6))
#     bpOne = ax.boxplot(data1, positions=[1, 4], notch=True, widths=boxWidth,
#                        patch_artist=True, boxprops=dict(facecolor="C0"))
#     bpTwo = ax.boxplot(data2, positions=[2, 5], notch=True, widths=boxWidth,
#                        patch_artist=True, boxprops=dict(facecolor="C2"))
#     spacer = "                      "
#     leftSubTitle = spacer + leftSubTitleText
#     rightSubTitle = rightSubTitleText + spacer
#     ax.set_xticklabels([leftSubTitle, '', '', rightSubTitle], fontweight='bold', fontsize=15)
#     traceuse.title('Comparison of ' + nameOfMetric, fontweight='bold', fontsize=15)
#     traceuse.xlabel('Performance Metric by ' + xAxisText, fontweight='bold', fontsize=15)
#     traceuse.ylabel(yAxisText, fontweight='bold', fontsize=15)
#     leftDifferenceStatsFrac = (round(leftDifferenceStats.iat[0, 14], 3)) * 100
#     leftDifferenceStatsFrac = round(leftDifferenceStatsFrac)
#     leftT = round(leftDifferenceStats.iat[0, 1], 2)
#     leftN = leftDifferenceStats.iat[0, 2] + 1
#     leftPValue = round(leftDifferenceStats.iat[0, 4], 3)
#     if leftPValue < 0.001:
#         leftPValue = "< 0.001"
#     rightDifferenceStatsFrac = (round(rightDifferenceStats.iat[0, 14], 3)) * 100
#     rightDifferenceStatsFrac = round(rightDifferenceStatsFrac)
#     rightT = round(rightDifferenceStats.iat[0, 1], 2)
#     rightN = rightDifferenceStats.iat[0, 2] + 1
#     rightPValue = round(rightDifferenceStats.iat[0, 4], 3)
#     if rightPValue < 0.001:
#         rightPValue = "< 0.001"
#     if leftDifferenceStats.iat[0, 13] > 99:
#         leftDifferenceStats = round(leftDifferenceStats.iat[0, 13])
#     else:
#         leftDifferenceStats = round(leftDifferenceStats.iat[0, 13], 2)
#     if rightDifferenceStats.iat[0, 13] > 99:
#         rightDifferenceStats = round(rightDifferenceStats.iat[0, 13])
#     else:
#         rightDifferenceStats = round(rightDifferenceStats.iat[0, 13], 2)
#
#     xOne, xTwo, xThree, xFour = 1, 2, 4, 5
#     yMax, padding, color = maxHeight4Text * 1.025, maxHeight4Text * 0.025, 'black'
#     traceuse.plot([xOne, xOne, xTwo, xTwo], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#     traceuse.plot([xThree, xThree, xFour, xFour], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#
#     if nameOfMetric == "Accuracy":
#         traceuse.text((xOne + xTwo) * 0.5, yMax + padding,
#                       performanceMetric + str(leftDifferenceStats) + units,
#                       ha="center", va="bottom", color=color, fontsize=11, fontweight='bold')
#         traceuse.text((xThree + xFour) * 0.5, yMax + padding,
#                       performanceMetric + str(rightDifferenceStats) + units,
#                       ha="center", va="bottom", color=color, fontsize=11, fontweight='bold')
#         traceuse.text((xOne + xTwo) * 0.5, yMax - padding,
#                       "p-Value: " + str(leftPValue),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         traceuse.text((xThree + xFour) * 0.5, yMax - padding,
#                       "p-Value: " + str(rightPValue),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         traceuse.text((xOne + xTwo) * 0.5, yMax - 2.5*padding,
#                       "t = " + str(leftT),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         traceuse.text((xThree + xFour) * 0.5, yMax - 2.5*padding,
#                       "t = " + str(rightT),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         traceuse.text((xOne + xTwo) * 0.5, yMax - 4 * padding,
#                       "n = " + str(leftN),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         traceuse.text((xThree + xFour) * 0.5, yMax - 4 * padding,
#                       "n = " + str(rightN),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     else:
#         traceuse.text((xOne + xTwo) * 0.5, yMax + padding,
#                       performanceMetric + str(leftDifferenceStats) + units + "/" + str(leftDifferenceStatsFrac) + "%",
#                       ha="center", va="bottom", color=color, fontsize=11, fontweight='bold')
#         traceuse.text((xThree + xFour) * 0.5, yMax + padding,
#                       performanceMetric + str(rightDifferenceStats) + units + "/" + str(rightDifferenceStatsFrac) + "%",
#                       ha="center", va="bottom", color=color, fontsize=11, fontweight='bold')
#         traceuse.text((xOne + xTwo) * 0.5, yMax - padding,
#                       "p-Value: " + str(leftPValue),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
...
#                       "n = " + str(rightN),
#                       ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#         ax.legend([bpOne["boxes"][0], bpTwo["boxes"][0]], ['Assessment', 'Testing'], fontsize=10, loc='upper center')
#
#     # ax.set_xlim(0, 6)
#     # for whisker in bpOne['whiskers']: whisker.set(color='#8B008B', linewidth=1.5, linestyle=":")
#     PlotSite = '../DataResults/Stats/SummarizingStats/Charts/'
#     name = PlotSite + filenameForCharts + ".pdf"
#     traceuse.show(block=False)
#     traceuse.savefig(name, bbox_inches='tight')
#     traceuse.pause(0.1)
#     traceuse.close("all")
...
#                xAxisText,
#                filenameForCharts,
#                betweenAnalysisMetricRL,
#                betweenAnalysisMetricIL,
#                betweenAnalysisMetricAC,
#                betweenAnalysisMetricSP):
#     pass
#
#     barWidth = 0.85
#     # fig = traceuse.subplots(figsize=(16, 8))
#     # if nameOfMetric == "Accuracy":
#     #     performanceMetric, units = "Error Reduction: ", "%"
#     # else:
#     #     performanceMetric, units = "Time Savings: ", " Secs"
#     # data1 = [metricAssessListSampleLeft, metricTestListSampleLeft]
#     # data2 = [metricAssessListSampleRight, metricTestListSampleRight]
#     fig, ax = traceuse.subplots(figsize=(16, 9))
#     # bpOne = ax.boxplot(data1, positions=[1, 4], notch=True, widths=boxWidth,
#     #                    patch_artist=True, boxprops=dict(facecolor="C0"))
#     # bpTwo = ax.boxplot(data2, positions=[2, 5], notch=True, widths=boxWidth,
#     #                    patch_artist=True, boxprops=dict(facecolor="C2"))
...
#     # leftSubTitle = spacer + leftSubTitleText
#     # rightSubTitle = rightSubTitleText + spacer
#     ax.set_xticklabels([leftSubTitleText,
#                         leftSubTitleText,
#                         rightSubTitleText,
#                         leftSubTitleText,
#                         rightSubTitleText,
...
#                         rightSubTitleText,
#                         leftSubTitleText,
#                         rightSubTitleText], fontweight='bold', fontsize=12)
#     ax.set_xticklabels(["",
#                         "",
#                         "",
#                         "",
...
#     traceuse.title('Performance Metrics ' + xAxisText, fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     traceuse.xlabel(
#         '              Resumption Lag        Interruption Lag     Accuracy|Optimality             Speed                     ',
#         fontweight='bold', fontsize=18, fontname='DejaVu Sans')
#     # traceuse.xlabel('     Resumption Lag              Interruption Lag           Accuracy|Optimality                   Speed            ', fontweight='bold', fontsize=15, fontname='DejaVu Sans')
#     traceuse.ylabel("Improvements (Percent Change)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         traceuse.ylabel("Improvements (Average Change)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#
#     leftRLFrac = (round(leftRL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         leftRLFrac = (round(leftRL.iat[0, 9], 3))
#     # leftRLFrac = (round(leftRL.iat[0, 14], 3)) * 100
#     # leftRLFrac = round(leftRLFrac)
#     leftRLSD = (round(leftRL.iat[0, 10], 3))
#     leftRLT = round(leftRL.iat[0, 1], 2)
#     leftRLN = leftRL.iat[0, 2] + 1
#     leftRLPValue = round(leftRL.iat[0, 4], 3)
#     if leftRLPValue < 0.001:
#         leftRLPValue = "< 0.001"
#     rightRLFrac = (round(rightRL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         rightRLFrac = (round(rightRL.iat[0, 11], 3))
#     # rightRLFrac = (round(rightRL.iat[0, 14], 3)) * 100
#     # rightRLFrac = round(rightRLFrac)
#     rightRLSD = (round(rightRL.iat[0, 12], 3))
#     rightRLT = round(rightRL.iat[0, 1], 2)
#     rightRLN = rightRL.iat[0, 2] + 1
#     rightRLPValue = round(rightRL.iat[0, 4], 3)
#     if rightRLPValue < 0.001:
#         rightRLPValue = "< 0.001"
#
#     leftILFrac = (round(leftIL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         leftILFrac = (round(leftIL.iat[0, 9], 3))
#     # leftILFrac = (round(leftIL.iat[0, 14], 3)) * 100
#     # leftILFrac = round(leftILFrac)
#     leftILSD = (round(leftIL.iat[0, 10], 3))
#     leftILT = round(leftIL.iat[0, 1], 2)
#     leftILN = leftIL.iat[0, 2] + 1
#     leftILPValue = round(leftIL.iat[0, 4], 3)
#     if leftILPValue < 0.001:
#         leftILPValue = "< 0.001"
#     rightILFrac = (round(rightIL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         rightILFrac = (round(rightIL.iat[0, 11], 3))
#     # rightILFrac = (round(rightIL.iat[0, 14], 3)) * 100
#     # rightILFrac = round(rightILFrac)
#     rightILSD = (round(rightIL.iat[0, 12], 3))
#     rightILT = round(rightIL.iat[0, 1], 2)
#     rightILN = rightIL.iat[0, 2] + 1
#     rightILPValue = round(rightIL.iat[0, 4], 3)
#     if rightILPValue < 0.001:
#         rightILPValue = "< 0.001"
#
#     # Accuracies and efficiencies are already computed as percentages.
#     leftACFrac = (round(leftAC.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         leftACFrac = (round(leftAC.iat[0, 9], 3))
#     # leftACFrac = (round(leftAC.iat[0, 14], 3))# * 100
#     # leftACFrac = round(leftACFrac)
#     leftACSD = (round(leftAC.iat[0, 10], 3))
#     leftACT = round(leftAC.iat[0, 1], 2)
#     leftACN = leftAC.iat[0, 2] + 1
#     leftACPValue = round(leftAC.iat[0, 4], 3)
#     if leftACPValue < 0.001:
#         leftACPValue = "< 0.001"
#     rightACFrac = (round(rightAC.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         rightACFrac = (round(rightAC.iat[0, 11], 3))
#     # rightACFrac = (round(rightAC.iat[0, 14], 3))# * 100
#     # rightACFrac = round(rightACFrac)
#     rightACSD = (round(rightAC.iat[0, 12], 3))
#     rightACT = round(rightAC.iat[0, 1], 2)
#     rightACN = rightAC.iat[0, 2] + 1
#     rightACPValue = round(rightAC.iat[0, 4], 3)
#     if rightACPValue < 0.001:
#         rightACPValue = "< 0.001"
#
#     leftSPFrac = (round(leftSP.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         leftSPFrac = (round(leftSP.iat[0, 9], 3))
#     # leftSPFrac = (round(leftSP.iat[0, 14], 3)) * 100
#     # leftSPFrac = round(leftSPFrac)
#     leftSPSD = (round(leftSP.iat[0, 10], 3))
#     leftSPT = round(leftSP.iat[0, 1], 2)
#     leftSPN = leftSP.iat[0, 2] + 1
#     leftSPPValue = round(leftSP.iat[0, 4], 3)
#     if leftSPPValue < 0.001:
#         leftSPPValue = "< 0.001"
#     rightSPFrac = (round(rightSP.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Assessment" and rightSubTitleText == "Testing":
#         rightSPFrac = (round(rightSP.iat[0, 11], 3))
#     # rightSPFrac = (round(rightSP.iat[0, 14], 3)) * 100
#     # rightSPFrac = round(rightSPFrac)
#     rightSPSD = (round(rightSP.iat[0, 12], 3))
#     rightSPT = round(rightSP.iat[0, 1], 2)
#     rightSPN = rightSP.iat[0, 2] + 1
#     rightSPPValue = round(rightSP.iat[0, 4], 3)
#     if rightSPPValue < 0.001:
#         rightSPPValue = "< 0.001"
#
#     betweenAnalysisMetricRLPValue = round(betweenAnalysisMetricRL.iat[0, 4], 3)
#     if betweenAnalysisMetricRLPValue < 0.001:
#         betweenAnalysisMetricRLPValue = "< 0.001"
#     betweenAnalysisMetricILPValue = round(betweenAnalysisMetricIL.iat[0, 4], 3)
#     if betweenAnalysisMetricILPValue < 0.001:
#         betweenAnalysisMetricILPValue = "< 0.001"
#     betweenAnalysisMetricACPValue = round(betweenAnalysisMetricAC.iat[0, 4], 3)
#     if betweenAnalysisMetricACPValue < 0.001:
#         betweenAnalysisMetricACPValue = "< 0.001"
#     betweenAnalysisMetricSPPValue = round(betweenAnalysisMetricSP.iat[0, 4], 3)
#     if betweenAnalysisMetricSPPValue < 0.001:
#         betweenAnalysisMetricSPPValue = "< 0.001"
#
#     betweenAnalysisMetricRLT = round(betweenAnalysisMetricRL.iat[0, 1], 1)
#     betweenAnalysisMetricILT = round(betweenAnalysisMetricIL.iat[0, 1], 1)
#     betweenAnalysisMetricACT = round(betweenAnalysisMetricAC.iat[0, 1], 1)
#     betweenAnalysisMetricSPT = round(betweenAnalysisMetricSP.iat[0, 1], 1)
#
#     betweenAnalysisMetricRLN = round(betweenAnalysisMetricRL.iat[0, 2]) + 2
#     betweenAnalysisMetricILN = round(betweenAnalysisMetricIL.iat[0, 2]) + 2
#     betweenAnalysisMetricACN = round(betweenAnalysisMetricAC.iat[0, 2]) + 2
#     betweenAnalysisMetricSPN = round(betweenAnalysisMetricSP.iat[0, 2]) + 2
#
#     maxHeight4Text = max(leftRLFrac,
#                          rightRLFrac,
#                          leftILFrac,
#                          rightILFrac,
#                          leftACFrac,
...
#                          leftSPFrac,
#                          rightSPFrac)
#     xOne, xTwo, xThree, xFour, xFive, xSix, xSeven, xEight = -0.425, 1.275, 1.565, 3.275, 3.565, 5.275, 5.565, 7.275
#     yMax, padding, color = maxHeight4Text * 1.025, maxHeight4Text * 0.025, 'black'
#     traceuse.plot([xOne, xOne, xTwo, xTwo], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#     traceuse.plot([xThree, xThree, xFour, xFour], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#     traceuse.plot([xFive, xFive, xSix, xSix], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#     traceuse.plot([xSeven, xSeven, xEight, xEight], [yMax, yMax + padding, yMax + padding, yMax], lw=1.2, color=color)
#
#     # Demarc for interStats Start
#     traceuse.text((xOne + xTwo) * 0.5, yMax + padding,
#                   # "Between "+
#                   # xAxisText,
#                   "n.s",
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xThree + xFour) * 0.5, yMax + padding,
#                   # "Between "+
#                   # xAxisText,
#                   "n.s",
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xFive + xSix) * 0.5, yMax + padding,
#                   # "Between "+
#                   # xAxisText,
#                   "n.s",
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xSeven + xEight) * 0.5, yMax + padding,
#                   # "Between "+
#                   # xAxisText,
#                   "n.s",
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     # traceuse.text((xOne + xTwo) * 0.5, yMax - padding/2,
#     #               "p-Value: " + str(betweenAnalysisMetricRLPValue),#+", t= "+str(betweenAnalysisMetricRLT)+", n= "+str(betweenAnalysisMetricRLN),
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     # traceuse.text((xThree + xFour) * 0.5, yMax - padding/2,
#     #               "p-Value: " + str(betweenAnalysisMetricILPValue), #+", t= "+str(betweenAnalysisMetricILT)+", n= "+str(betweenAnalysisMetricILN),
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     # traceuse.text((xFive + xSix) * 0.5, yMax - padding/2,
#     #               "p-Value: " + str(betweenAnalysisMetricACPValue), #+", t= "+str(betweenAnalysisMetricACT)+", n= "+str(betweenAnalysisMetricACN),
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     # traceuse.text((xSeven + xEight) * 0.5, yMax - padding/2,
#     #               "p-Value: " + str(betweenAnalysisMetricSPPValue), #+", t= "+str(betweenAnalysisMetricSPT)+", n= "+str(betweenAnalysisMetricSPN),
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#
#     # traceuse.text((xOne + xTwo) * 0.5, yMax - 2.5 * padding,
#     #               "t = " + str(leftRLT),
...
#     #               "n = " + str(rightRLN),
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     # Demarc for interStats End
#     # Demarc for intraStats Stats
#     # traceuse.text(0, leftRLFrac - 1.25,
#     #               "p-Value: " + str(leftRLPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(0, leftRLFrac - 2,
#     #               "t = " + str(leftRLT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(0, leftRLFrac - 2.75,
#     #               "n = " + str(leftRLN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(0.85, rightRLFrac - 1.25,
#     #               "p-Value: " + str(rightRLPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(0.85, rightRLFrac - 2,
#     #               "t = " + str(rightRLT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(0.85, rightRLFrac - 2.75,
#     #               "n = " + str(rightRLN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.0, leftILFrac - 1.25,
#     #               "p-Value: " + str(leftILPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.0, leftILFrac - 2,
#     #               "t = " + str(leftILT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.0, leftILFrac - 2.75,
#     #               "n = " + str(leftILN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.85, rightILFrac - 1.25,
#     #               "p-Value: " + str(rightILPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.85, rightILFrac - 2,
#     #               "t = " + str(rightILT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(2.85, rightILFrac - 2.75,
#     #               "n = " + str(rightILN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # if leftACFrac < 10:
#     #     pass
#     #     traceuse.text(4.0, leftACFrac + 3,
#     #                   "p-Value: " + str(leftACPValue),
#     #                   ha="center", va="bottom", color='black', fontsize=9, fontweight='bold')
#     #     traceuse.text(4.0, leftACFrac + 2.25,
#     #                   "t = " + str(leftACT),
#     #                   ha="center", va="bottom", color='black', fontsize=9, fontweight='bold')
#     #     traceuse.text(4.0, leftACFrac + 1.5,
#     #                   "n = " + str(leftACN),
#     #                   ha="center", va="bottom", color='black', fontsize=9, fontweight='bold')
#     #     traceuse.arrow(4.0, leftACFrac + 1.25, 0, -1.0, head_width = 0.1, width = 0.025, ec ='blue')
#     # else:
#     #     traceuse.text(4.0, leftACFrac - 1.25,
#     #                   "p-Value: " + str(leftACPValue),
#     #                   ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     #     traceuse.text(4.0, leftACFrac - 2,
#     #                   "t = " + str(leftACT),
#     #                   ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     #     traceuse.text(4.0, leftACFrac - 2.75,
#     #                   "n = " + str(leftACN),
#     #                   ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(4.85, rightACFrac - 1.25,
#     #               "p-Value: " + str(rightACPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(4.85, rightACFrac - 2,
#     #               "t = " + str(rightACT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(4.85, rightACFrac - 2.75,
#     #               "n = " + str(rightACN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.0, leftSPFrac - 1.25,
#     #               "p-Value: " + str(leftSPPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.0, leftSPFrac - 2,
#     #               "t = " + str(leftSPT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.0, leftSPFrac - 2.75,
#     #               "n = " + str(leftSPN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.85, rightSPFrac - 1.25,
#     #               "p-Value: " + str(rightSPPValue),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.85, rightSPFrac - 2,
#     #               "t = " + str(rightSPT),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#     # traceuse.text(6.85, rightSPFrac - 2.75,
#     #               "n = " + str(rightSPN),
#     #               ha="center", va="bottom", color='white', fontsize=9, fontweight='bold')
#
#     # set height of bar
#     leftAnalysisMetric = [leftRLFrac,
#                           leftILFrac,
#                           leftACFrac,
#                           leftSPFrac]
#     rightAnalysisMetric = [rightRLFrac,
#                            rightILFrac,
#                            rightACFrac,
#                            rightSPFrac]
#
#     # Set position of left bars on X Axis
#     leftAnalysisMetricBar = [0, 2, 4, 6]
#     rightAnalysisMetricBar = [x + barWidth for x in leftAnalysisMetricBar]
#     SDsLeft = [leftRLSD, leftILSD, leftACSD, leftSPSD]
#     SDsRight = [rightRLSD, rightILSD, rightACSD, rightSPSD]
#
#     # Make the plot
#     traceuse.bar(leftAnalysisMetricBar, leftAnalysisMetric, color='#1035AC', width=barWidth,
#             edgecolor='grey', label=leftSubTitleText)
#     traceuse.bar(rightAnalysisMetricBar, rightAnalysisMetric, color='#028A0F', width=barWidth,
#             edgecolor='grey', label=rightSubTitleText)
#
#     traceuse.legend(fontsize=13, loc = 6)
#     PlotSite = '../DataResults/Stats/SummarizingStats/Charts/'
#     name = PlotSite + filenameForCharts + ".pdf"
#     traceuse.show(block=False)
#     traceuse.savefig(name, bbox_inches='tight')
...
#                         ""], fontweight='bold', fontsize=12)
#     traceuse.title('Performance Metrics ' + xAxisText, fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     traceuse.xlabel('              Resumption Lag        Interruption Lag     Accuracy|Optimality             Speed                     ', fontweight='bold', fontsize=18, fontname='DejaVu Sans')
#     traceuse.ylabel("Averages", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     if leftSubTitleText == "Pre-Intervention" and rightSubTitleText == "Post-Intervention":
#         traceuse.ylabel("Averages", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#
#     leftRLFrac = (round(leftRL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Pre-Intervention" and rightSubTitleText == "Post-Intervention":
...
#         rightSPPValue = "< 0.001"
#
#     betweenAnalysisMetricRLPValue = "p-Value = " + str(round(betweenAnalysisMetricRL.iat[0, 4], 3))
#     if round(betweenAnalysisMetricRL.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricRLPValue = "p-Value < 0.001"
#     betweenAnalysisMetricILPValue =  "p-Value = " + str(round(betweenAnalysisMetricIL.iat[0, 4], 3))
#     if round(betweenAnalysisMetricIL.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricILPValue = "p-Value < 0.001"
#     betweenAnalysisMetricACPValue =  "p-Value = " + str(round(betweenAnalysisMetricAC.iat[0, 4], 3))
#     if round(betweenAnalysisMetricAC.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricACPValue = "p-Value < 0.001"
#     betweenAnalysisMetricSPPValue =  "p-Value = " + str(round(betweenAnalysisMetricSP.iat[0, 4], 3))
#     if round(betweenAnalysisMetricSP.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricSPPValue = "p-Value < 0.001"
#
#     betweenAnalysisMetricRLT = round(betweenAnalysisMetricRL.iat[0, 1], 1)
#     betweenAnalysisMetricILT = round(betweenAnalysisMetricIL.iat[0, 1], 1)
#     betweenAnalysisMetricACT = round(betweenAnalysisMetricAC.iat[0, 1], 1)
...
#     #               xAxisText,
#     #               ha="center", va="bottom", color=color, fontsize=10, fontweight='bold')
#     traceuse.text((xOne + xTwo) * 0.5, yMax - padding/2, betweenAnalysisMetricRLPValue,
#                   # "p-Value: " + str(betweenAnalysisMetricRLPValue),#+", t= "+str(betweenAnalysisMetricRLT)+", n= "+str(betweenAnalysisMetricRLN),
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xThree + xFour) * 0.5, yMax - padding/2, betweenAnalysisMetricILPValue,
#                   # "p-Value: " + str(betweenAnalysisMetricILPValue),#+", t= "+str(betweenAnalysisMetricILT)+", n= "+str(betweenAnalysisMetricILN),
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xFive + xSix) * 0.5, yMax - padding/2, betweenAnalysisMetricACPValue,
#                   # "p-Value: " + str(betweenAnalysisMetricACPValue),#+", t= "+str(betweenAnalysisMetricACT)+", n= "+str(betweenAnalysisMetricACN),
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xSeven + xEight) * 0.5, yMax - padding/2, betweenAnalysisMetricSPPValue,
#                   # "p-Value: " + str(betweenAnalysisMetricSPPValue),#+", t= "+str(betweenAnalysisMetricSPT)+", n= "+str(betweenAnalysisMetricSPN),
#                   ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     # Demarc for interStats End
#     # Demarc for intraStats Stats
...
#     SDsRight = [rightRLSD, rightILSD, rightACSD, rightSPSD]
#
#     # Make the plot with SD lines
#     # traceuse.bar(leftAnalysisMetricBar, leftAnalysisMetric, yerr=SDsLeft, color='chartreuse', width=barWidth,
#     #         edgecolor='grey', label=leftSubTitleText)
#     # traceuse.bar(rightAnalysisMetricBar, rightAnalysisMetric, yerr=SDsRight, color='lemonchiffon', width=barWidth,
#     #         edgecolor='grey', label=rightSubTitleText)
#
#     # Make the plot without SD lines or plotted subtitles (passing blanks to ax.set_xticklabels
#     traceuse.bar(leftAnalysisMetricBar, leftAnalysisMetric, color='#ED1E78', width=barWidth,
#                  edgecolor='grey', label=leftSubTitleText)
#     traceuse.bar(rightAnalysisMetricBar, rightAnalysisMetric, color='#652D92', width=barWidth,
#                  edgecolor='grey', label=rightSubTitleText)
#
#     traceuse.legend(fontsize=14, loc = 6)
#     PlotSite = '../DataResults/Stats/SummarizingStats/Charts/'
#     name = PlotSite + filenameForCharts + ".pdf"
#     traceuse.show(block=False)
#     traceuse.savefig(name, bbox_inches='tight')
...
#     # traceuse.xlabel('              Resumption Lag        Interruption Lag     Accuracy|Optimality             Speed                     ', fontweight='bold', fontsize=18, fontname='DejaVu Sans')
#     traceuse.xlabel(
#         '         Resumption Lag  Interruption Lag       Speed                   Accuracy|Optimality      ',
#         fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     traceuse.ylabel("Averages (Seconds)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     # if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#     #     traceuse.ylabel("Averages (Seconds)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#
#     leftRLFrac = (round(leftRL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
...
#         rightSPPValue = "< 0.001"
#
#     betweenAnalysisMetricRLPValue = "p = " + str(round(betweenAnalysisMetricRL.iat[0, 4], 3))
#     if round(betweenAnalysisMetricRL.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricRLPValue = "p < 0.001"
#     elif round(betweenAnalysisMetricRL.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricRLPValue = "n.s"
#     betweenAnalysisMetricILPValue =  "p = " + str(round(betweenAnalysisMetricIL.iat[0, 4], 3))
#     if round(betweenAnalysisMetricIL.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricILPValue = "p < 0.001"
#     elif round(betweenAnalysisMetricIL.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricILPValue = "n.s"
#     betweenAnalysisMetricACPValue =  "p = " + str(round(betweenAnalysisMetricAC.iat[0, 4], 3))
#     if round(betweenAnalysisMetricAC.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricACPValue = "p < 0.001"
#     elif round(betweenAnalysisMetricAC.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricACPValue = "n.s"
#     betweenAnalysisMetricSPPValue =  "p = " + str(round(betweenAnalysisMetricSP.iat[0, 4], 3))
#     if round(betweenAnalysisMetricSP.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricSPPValue = "p < 0.001"
#     elif round(betweenAnalysisMetricSP.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricSPPValue = "n.s"
#
#     betweenAnalysisMetricRLT = round(betweenAnalysisMetricRL.iat[0, 1], 1)
#     betweenAnalysisMetricILT = round(betweenAnalysisMetricIL.iat[0, 1], 1)
#     betweenAnalysisMetricACT = round(betweenAnalysisMetricAC.iat[0, 1], 1)
...
#                          leftSPFrac,
#                          rightSPFrac)
#     maxHeight4TextRL = max(leftRLFrac, rightRLFrac) * 1.025
#     maxHeight4TextIL = max(leftILFrac, rightILFrac) * 1.025
#     maxHeight4TextSP = max(leftSPFrac, rightSPFrac) * 1.025
#     maxHeight4TextAC = max(leftACFrac, rightACFrac) * 1.025
#     xOne, xTwo, xThree, xFour, xFive, xSix, xSeven, xEight = (-0.425/2)+.25, (1.275/2)+0.25, 1.565/2+1.2, 3.275/2+1.2, 3.565/2+2.2, 5.275/2+2.2, 5.565/2+4.3, 7.275/2+4.3
#     yMax, padding, color = maxHeight4Text * 1.025, maxHeight4Text * 0.025, 'black'
#     traceuse.plot([xOne, xOne, xTwo, xTwo], [maxHeight4TextRL * 1.1, maxHeight4TextRL * 1.1 + padding, maxHeight4TextRL * 1.1 + padding, maxHeight4TextRL * 1.1], lw=1.2, color=color)
#     traceuse.plot([xThree, xThree, xFour, xFour], [maxHeight4TextIL * 1.15, maxHeight4TextIL * 1.15 + padding, maxHeight4TextIL * 1.15 + padding, maxHeight4TextIL * 1.15], lw=1.2, color=color)
#     traceuse.plot([xFive, xFive, xSix, xSix], [maxHeight4TextSP, maxHeight4TextSP + padding, maxHeight4TextSP + padding, maxHeight4TextSP], lw=1.2, color=color)
#     # traceuse.plot([xSeven, xSeven, xEight, xEight], [maxHeight4TextAC, maxHeight4TextAC + padding, maxHeight4TextAC + padding, maxHeight4TextAC], lw=1.2, color=color)
#
#     traceuse.text((xOne + xTwo) * 0.5, maxHeight4TextRL * 1.1 + padding, betweenAnalysisMetricRLPValue,
#                   # "p: " + str(betweenAnalysisMetricRLPValue),#+", t= "+str(betweenAnalysisMetricRLT)+", n= "+str(betweenAnalysisMetricRLN),
#                   ha="center", va="bottom", color=color, fontsize=15, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xThree + xFour) * 0.5, maxHeight4TextIL * 1.15 + padding, betweenAnalysisMetricILPValue,
#                   # "p: " + str(betweenAnalysisMetricILPValue),#+", t= "+str(betweenAnalysisMetricILT)+", n= "+str(betweenAnalysisMetricILN),
#                   ha="center", va="bottom", color=color, fontsize=15, fontweight='bold', fontname='DejaVu Sans')
#     traceuse.text((xFive + xSix) * 0.5, maxHeight4TextSP + padding, betweenAnalysisMetricSPPValue, #betweenAnalysisMetricACPValue,
#                   # "p: " + str(betweenAnalysisMetricACPValue),#+", t= "+str(betweenAnalysisMetricACT)+", n= "+str(betweenAnalysisMetricACN),
#                   ha="center", va="bottom", color=color, fontsize=15, fontweight='bold', fontname='DejaVu Sans')
#     # traceuse.text((xSeven + xEight) * 0.5, maxHeight4TextAC + padding, betweenAnalysisMetricACPValue, #betweenAnalysisMetricSPPValue,
#     #               # "p: " + str(betweenAnalysisMetricSPPValue),#+", t= "+str(betweenAnalysisMetricSPT)+", n= "+str(betweenAnalysisMetricSPN),
#     #               ha="center", va="bottom", color=color, fontsize=13, fontweight='bold', fontname='DejaVu Sans')
#     # Demarc for interStats End
#     # Demarc for intraStats Stats
#     # traceuse.text(0, leftRLFrac - 1.25,
...
#
#     # Set position of left bars on X Axis
#     leftAnalysisMetricBar = [0, 2, 4, 7.09]
#     rightAnalysisMetricBar = [x + barWidth for x in leftAnalysisMetricBar]
#
#     # Make the plot without SD lines or plotted subtitles (passing blanks to ax.set_xticklabels
#     if rightSubTitleText == "Post-Intervention":
#         traceuse.bar(leftAnalysisMetricBar, leftAnalysisMetric, color='#ED1E78', width=barWidth,
#                      edgecolor='grey', label=leftSubTitleText)
#         traceuse.bar(rightAnalysisMetricBar, rightAnalysisMetric, color='#652D92', width=barWidth,
#                      edgecolor='grey', label=rightSubTitleText)
#         traceuse.legend(fontsize=16, loc=1)
#
#         # Second Y Axis for Accuracy/Optimality
#         twin2 = ax.twinx()
#         twin2.spines.right.set_position(("axes", .73))
#         twin2.bar(5.565/2+4.3, leftACFrac, color='#ED1E78', width=barWidth, edgecolor='grey')
#         twin2.bar(7.275/2+4.3, rightACFrac, color='#652D92', width=barWidth, edgecolor='grey')
#         maxHeightAxisAC = max([leftACFrac, rightACFrac]) * 2.2
#         twin2.set_ylim(0, maxHeightAxisAC)
#
#     if rightSubTitleText == "Alternative":
#         traceuse.bar(leftAnalysisMetricBar, leftAnalysisMetric, color='#1035AC', width=barWidth,
#                      edgecolor='grey', label=leftSubTitleText)
#         traceuse.bar(rightAnalysisMetricBar, rightAnalysisMetric, color='#028A0F', width=barWidth,
#                      edgecolor='grey', label=rightSubTitleText)
...
#         twin2 = ax.twinx()
#         twin2.spines.right.set_position(("axes", .73))
#         twin2.bar(5.565 / 2 + 4.3, leftACFrac, color='#1035AC', width=barWidth, edgecolor='grey')
#         twin2.bar(7.275 / 2 + 4.3, rightACFrac, color='#028A0F', width=barWidth, edgecolor='grey')
#         maxHeightAxisAC = max([leftACFrac, rightACFrac]) * 2.05
#         twin2.set_ylim(0, maxHeightAxisAC)
#
#
#     maxHeight4StatAC, padder = max([leftACFrac, rightACFrac]) * 1.025, max([leftACFrac, rightACFrac]) * 0.025
#     traceuse.text(6.05, (max([leftACFrac, rightACFrac]))*0.05,
#                                 "Percentage of Inaccuracy/Suboptimality",
#                                 ha="center", va="bottom", color="black", fontsize=20, fontweight='bold', rotation=90)
#     traceuse.plot([xSeven, xSeven, xEight, xEight],
#                   [maxHeight4StatAC, maxHeight4StatAC + padder, maxHeight4StatAC + padder, maxHeight4StatAC], lw=1.2,
#                   color=color)
#     traceuse.text((xSeven + xEight) * 0.5, maxHeight4StatAC + padder, betweenAnalysisMetricACPValue,
#                   ha="center", va="bottom", color=color, fontsize=15, fontweight='bold', fontname='DejaVu Sans')
#
#
#
#     # traceuse.legend(fontsize=14, loc = 6)
#     PlotSite = '../DataResults/Stats/SummarizingStats/Charts/DualAxes/'
#     name = PlotSite + filenameForCharts + ".pdf"
#     traceuse.show(block=False)
#     traceuse.savefig(name, bbox_inches='tight')
#     traceuse.pause(0.5)
...
#         betweenAnalysisMetricSP,
#         betweenAnalysisMetricAC,
#         betweenAnalysisMetricOPT):
#     pass
#
#     barWidth = 0.5
#     fig, ax = traceuse.subplots(2, figsize=(16, 9))
#     ax[0].set_xticklabels([leftSubTitleText,
#                         leftSubTitleText,
#                         rightSubTitleText,
#                         leftSubTitleText,
#                         rightSubTitleText,
...
#                         "",
#                         ""], fontweight='bold', fontsize=12)
#     ax[0].set_title('Performance Metrics ' + xAxisText, fontweight='bold', fontsize=24, fontname='DejaVu Sans')
#     # ax[0].xlabel('              Resumption Lag        Interruption Lag     Accuracy|Optimality             Speed                     ', fontweight='bold', fontsize=18, fontname='DejaVu Sans')
#     ax[0].set_xlabel(
#         '              Resumption Lag        Interruption Lag                 Speed                      ',
#         fontweight='bold', fontsize=24, fontname='DejaVu Sans')
#     ax[1].set_xlabel(
#         '               Correctness                                         Optimality                ',
#         fontweight='bold', fontsize=24, fontname='DejaVu Sans')
#     ax[0].set_ylabel("Averages (Seconds)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     ax[1].set_ylabel("Error Rates", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#     # if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#     #     ax[0].ylabel("Averages (Seconds)", fontweight='bold', fontsize=20, fontname='DejaVu Sans')
#
#     leftRLFrac = (round(leftRL.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#         leftRLFrac = (round(leftRL.iat[0, 9], 3))
...
#         rightILPValue = "< 0.001"
#
#     # Error of Path Tracing Data Handling
#     leftErrorFrac = (round(leftError.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#         leftErrorFrac = (round(leftError.iat[0, 9], 3))
#     leftErrorSD = (round(leftError.iat[0, 10], 3))
#     leftErrorT = round(leftError.iat[0, 1], 2)
#     leftErrorN = leftError.iat[0, 2] + 1
#     leftErrorPValue = round(leftError.iat[0, 4], 3)
#     if leftErrorPValue < 0.001:
#         leftErrorPValue = "< 0.001"
#     rightErrorFrac = (round(rightError.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#         rightErrorFrac = (round(rightError.iat[0, 11], 3))
#     rightErrorSD = (round(rightError.iat[0, 12], 3))
#     rightErrorT = round(rightError.iat[0, 1], 2)
#     rightErrorN = rightError.iat[0, 2] + 1
#     rightErrorPValue = round(rightError.iat[0, 4], 3)
#     if rightErrorPValue < 0.001:
#         rightErrorPValue = "< 0.001"
#
#     # Optimality of ToH Data Handling
#     leftSuboptimalityFrac = (round(leftSuboptimality.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#         leftSuboptimalityFrac = (round(leftSuboptimality.iat[0, 9], 3))
#     leftSuboptimalitySD = (round(leftSuboptimality.iat[0, 10], 3))
#     leftSuboptimalityT = round(leftSuboptimality.iat[0, 1], 2)
#     leftSuboptimalityN = leftSuboptimality.iat[0, 2] + 1
#     leftSuboptimalityPValue = round(leftSuboptimality.iat[0, 4], 3)
#     if leftSuboptimalityPValue < 0.001:
#         leftSuboptimalityPValue = "< 0.001"
#     rightSuboptimalityFrac = (round(rightSuboptimality.iat[0, 14], 3))  # * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
#         rightSuboptimalityFrac = (round(rightSuboptimality.iat[0, 11], 3))
#     rightSuboptimalitySD = (round(rightSuboptimality.iat[0, 12], 3))
#     rightSuboptimalityT = round(rightSuboptimality.iat[0, 1], 2)
#     rightSuboptimalityN = rightSuboptimality.iat[0, 2] + 1
#     rightSuboptimalityPValue = round(rightSuboptimality.iat[0, 4], 3)
#     if rightSuboptimalityPValue < 0.001:
#         rightSuboptimalityPValue = "< 0.001"
#
#
#     leftSPFrac = (round(leftSP.iat[0, 14], 3)) * 100
#     if leftSubTitleText == "Pre-Intervention" or "Supportive" and rightSubTitleText == "Post-Intervention" or "Alternative":
...
#     elif round(betweenAnalysisMetricAC.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricACPValue = "n.s"
#     betweenAnalysisMetricOPTPValue = "p = " + str(round(betweenAnalysisMetricOPT.iat[0, 4], 3))
#     if round(betweenAnalysisMetricOPT.iat[0, 4], 3) < 0.001:
#         betweenAnalysisMetricOPTPValue = "p < 0.001"
#     elif round(betweenAnalysisMetricOPT.iat[0, 4], 3) > 0.05:
#         betweenAnalysisMetricOPTPValue = "n.s"
#
#     betweenAnalysisMetricRLT = round(betweenAnalysisMetricRL.iat[0, 1], 1)
#     betweenAnalysisMetricILT = round(betweenAnalysisMetricIL.iat[0, 1], 1)
#     betweenAnalysisMetricACT = round(betweenAnalysisMetricAC.iat[0, 1], 1)
...
#                          leftSPFrac,
#                          rightSPFrac,
#                          leftSuboptimalityFrac,
#                          rightSuboptimalityFrac)
#     # maxHeight4TextRL = max(leftRLFrac, rightRLFrac) * 1.025
#     # ************************These are standard deviations not errors************************
#     maxHeight4TextRL = (max(leftRLFrac, rightRLFrac)) + ((max(leftRLSD, rightRLSD) * 1.05))#/2)
#     maxHeight4TextIL = (max(leftILFrac, rightILFrac)) + ((max(leftILSD, rightILSD) * 1.025))#/2)
#     maxHeight4TextSP = (max(leftSPFrac, rightSPFrac)) + ((max(leftSPSD, rightSPSD) * 1.025))#/2)
#     maxHeight4TextAC = (max(leftErrorFrac, rightErrorFrac)) + ((max(leftErrorSD, rightErrorSD) * 1.025))#/2)
#     maxHeight4TextOpt = (max(leftSuboptimalityFrac, rightSuboptimalityFrac)) + ((max(leftSuboptimalitySD, rightSuboptimalitySD) * 1.025))#/2)
#     xOne, xTwo, xThree, xFour, xFive, xSix, xSeven, xEight, xNine, xTen = 0, 0.5, 1.25, 1.75, 2.5, 3.0, 0, 0.5, 1.5, 2.0
#     yMax, padding, color = maxHeight4Text * 1.025, maxHeight4Text * 0.025, 'black'
#
#     # line = lines(x, y)
#     # ax[0].add_line(line)
#     ax[0].plot([xOne, xOne, xTwo, xTwo],
#                [maxHeight4TextRL * 1.05, maxHeight4TextRL * 1.1 + padding/2, maxHeight4TextRL * 1.1 + padding/2,
#                 maxHeight4TextRL * 1.05], lw=1.2, color=color)
#     ax[0].plot([xThree, xThree, xFour, xFour],
#                [maxHeight4TextIL * 1.1, maxHeight4TextIL * 1.1 + padding, maxHeight4TextIL * 1.1 + padding,
#                 maxHeight4TextIL * 1.1], lw=1.2, color=color)
#     # ax[0].plot([xFive, xFive, xSix, xSix], [maxHeight4TextSP, maxHeight4TextSP + padding, maxHeight4TextSP + padding, maxHeight4TextSP], lw=1.2, color=color)
#     ax[1].plot([xSeven, xSeven, xEight, xEight],
#                [maxHeight4TextAC * 1.1, maxHeight4TextAC + padding/2, maxHeight4TextAC + padding/2, maxHeight4TextAC * 1.1],
#                lw=1.2, color=color)
#
#     #
#     ax[0].text(((xOne + xTwo) * 0.5), (maxHeight4TextRL + padding/8), betweenAnalysisMetricRLPValue, ha="center",
#                va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#
#     ax[0].text((xThree + xFour) * 0.5, maxHeight4TextIL + padding/8, betweenAnalysisMetricILPValue, ha="center",
#                va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#
#     ax[1].text((xSeven + xEight) * 0.5, maxHeight4TextAC + padding/6, betweenAnalysisMetricACPValue, ha="center",
#                va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#
#     # set height of bar
#     leftLagMetric = [leftRLFrac, leftILFrac]
#     rightLagMetric = [rightRLFrac, rightILFrac]
#
#     # leftSpeedMetric = [leftSPFrac]
#     # rightSpeedMetric = [rightSPFrac]
#
#     leftErrorMetrics = [leftErrorFrac]
#     rightErrorMetrics = [rightErrorFrac]
#
#     # Set position of left bars on X Axis
#     leftLagMetricBar = [0, 1.25]
#     rightLagMetricBar = [x + barWidth for x in leftLagMetricBar]
#
#     leftErrorMetricsBar = [0]
#     rightErrorMetricsBar = [x + barWidth for x in leftErrorMetricsBar]
#
#     SDsLeft = [leftRLSD, leftILSD]
#     SDsRight = [rightRLSD, rightILSD]
#
#     SDspeedLeft = [leftSPSD]
#     SDspeedRight = [rightSPSD]
#
#     SDsAccLeft = [leftErrorSD]
#     SDsAccRight = [rightErrorSD]
#
#     SDsOptLeft = [leftSuboptimalitySD]
#     SDsOptRight = [rightSuboptimalitySD]
#
#     # Make the plot without SD lines or plotted subtitles (passing blanks to ax.set_xticklabels
#     if rightSubTitleText == "Post-Intervention":
#         ax[0].bar(leftLagMetricBar, leftLagMetric, yerr=SDsLeft,
#                   color='#ED1E78', width=barWidth, edgecolor='grey', label=leftSubTitleText)
#         ax[0].bar(rightLagMetricBar, rightLagMetric, yerr=SDsRight,
#                   color='#652D92', width=barWidth, edgecolor='grey', label=rightSubTitleText)
#         ax[1].bar(leftErrorMetricsBar, leftErrorMetrics, yerr=SDsAccLeft,
#                   color='#ED1E78', width=barWidth, edgecolor='grey', label=leftSubTitleText)
#         ax[1].bar(rightErrorMetricsBar, rightErrorMetrics, yerr=SDsAccRight,
#                   color='#652D92', width=barWidth, edgecolor='grey', label=rightSubTitleText)
#         # leftErrorMetricsACC = max([leftErrorMetrics[0], rightErrorMetrics[0]]) * 1.95
#         # print("leftErrorMetricsACC", leftErrorMetricsACC)
#         # ax[1].set_ylim(0, leftErrorMetricsACC)
#         # ax[0].plot([3,3.25], [0.5,1.5], lw=1.2, color='white')
#         ax[0].legend(fontsize=16, loc=9)
#
#         # Second Y Axis for Speed (Time to Completion) on top chart
#         twin1 = ax[0].twinx()
#         twin1.spines.right.set_position(("axes", .66))
#         twin1.bar(2.5, leftSPFrac, color='#ED1E78', width=barWidth, yerr=SDspeedLeft,
#                   edgecolor='grey')
#         twin1.bar(3, rightSPFrac, color='#652D92', width=barWidth, yerr=SDspeedRight,
#                   edgecolor='grey')
#         maxHeightAxisSP = max([leftSPFrac, rightSPFrac]) * 2.05
#         twin1.set_ylim(0, maxHeightAxisSP)
#         twin1.plot([xFive, xFive, xSix, xSix],
#                    [maxHeight4TextSP * 1.05, maxHeight4TextSP * 1.1 + padding, maxHeight4TextSP * 1.1 + padding, maxHeight4TextSP * 1.05], lw=1.2,
#                    color=color)
#         twin1.text((xFive + xSix) * 0.5, maxHeight4TextSP + padding/4, betweenAnalysisMetricSPPValue, ha="center",
#                    va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#         twin1.text(2.075, (max([leftErrorFrac, rightErrorFrac])) * 0.025,
#                    "Averages (Seconds)",
#                    ha="center", va="bottom", color="black", fontsize=20, fontweight='bold', rotation=90)
#
#         # Second Y Axis for Optimality on bottom chart
#         twin2 = ax[1].twinx()
#         twin2.spines.right.set_position(("axes", .5))
#         twin2.bar(1.5, leftSuboptimalityFrac, color='#ED1E78', width=barWidth, yerr=SDsOptLeft, edgecolor='grey')
#         twin2.bar(2, rightSuboptimalityFrac, color='#652D92', width=barWidth, yerr=SDsOptRight, edgecolor='grey')
#         maxHeightAxisOPT = max([leftSuboptimalityFrac, rightSuboptimalityFrac]) * 1.85
#         twin2.set_ylim(0, maxHeightAxisOPT)
#         twin2.plot([xNine, xNine, xTen, xTen],
#                    [maxHeight4TextOpt * 1.05, maxHeight4TextOpt * 1.05 + padding, maxHeight4TextOpt * 1.05 + padding, maxHeight4TextOpt * 1.05],
#                    lw=1.2, color=color)
#         twin2.text((xNine + xTen) * 0.5, maxHeight4TextOpt + padding/12, betweenAnalysisMetricOPTPValue, ha="center",
#                    va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#         twin2.text(0.975, (max([leftErrorFrac, rightErrorFrac])) * 0.25,
#                    "Excessive Moves",
#                    ha="center", va="bottom", color="black", fontsize=20, fontweight='bold', rotation=90)
#
#     if rightSubTitleText == "Alternative":
#         ax[0].bar(leftLagMetricBar, leftLagMetric, yerr=SDsLeft,
#                   color='#1035AC', width=barWidth, edgecolor='grey', label=leftSubTitleText)
#         ax[0].bar(rightLagMetricBar, rightLagMetric, yerr=SDsRight,
#                   color='#028A0F', width=barWidth, edgecolor='grey', label=rightSubTitleText)
#         ax[1].bar(leftErrorMetricsBar, leftErrorMetrics, yerr=SDsAccLeft,
#                   color='#1035AC', width=barWidth, edgecolor='grey', label=leftSubTitleText)
#         ax[1].bar(rightErrorMetricsBar, rightErrorMetrics, yerr=SDsAccRight,
#                   color='#028A0F', width=barWidth, edgecolor='grey', label=rightSubTitleText)
#         ax[0].legend(fontsize=14, loc=9)
#
#         # Second Y Axis for Speed (Time to Completion) on top chart
#         twin1 = ax[0].twinx()
#         twin1.spines.right.set_position(("axes", .66))
#         twin1.bar(2.5, leftSPFrac, color='#1035AC', width=barWidth, yerr=SDspeedLeft, edgecolor='grey')
#         twin1.bar(3, rightSPFrac, color='#028A0F', width=barWidth, yerr=SDspeedRight, edgecolor='grey')
#         maxHeightAxisSP = max([leftSPFrac, rightSPFrac]) * 2.95
#         twin1.set_ylim(0, maxHeightAxisSP)
#         twin1.plot([xFive, xFive, xSix, xSix],
#                    [maxHeight4TextSP * 1.05, maxHeight4TextSP * 1.1 + padding, maxHeight4TextSP * 1.1 + padding,
#                     maxHeight4TextSP * 1.05], lw=1.2, color=color)
#         twin1.text((xFive + xSix) * 0.5, maxHeight4TextSP + padding/4, betweenAnalysisMetricSPPValue, ha="center",
#                    va="bottom", color=color, fontsize=20, fontweight='bold', fontname='DejaVu Sans')
#         twin1.text(2.075, (max([leftErrorFrac, rightErrorFrac])) * 0.025,
#                    "Averages (Seconds)",
...
#         twin2 = ax[1].twinx()
#         twin2.spines.right.set_position(("axes", .5))
#         twin2.bar(1.5, leftSuboptimalityFrac, color='#1035AC', width=barWidth, yerr=SDsOptLeft,
#                   edgecolor='grey')
#         twin2.bar(2, rightSuboptimalityFrac, color='#028A0F', width=barWidth, yerr=SDsOptRight,
#                   edgecolor='grey')
#         # twin2.Circle((3, .5), 0.2, color='r')
#         maxHeightAxisOPT = max([leftSuboptimalityFrac, rightSuboptimalityFrac]) * 2.25
#         twin2.set_ylim(0, maxHeightAxisOPT)
#         twin2.plot([xNine, xNine, xTen, xTen],
#                    [maxHeight4TextOpt * 1.05, maxHeight4TextOpt * 1.05 + padding, maxHeight4TextOpt * 1.05 + padding, maxHeight4TextOpt * 1.05],
#                    lw=1.2, color=color)
...
#                    ha="center", va="bottom", color="black", fontsize=20, fontweight='bold', rotation=90)
#
#     # ax[0].legend(fontsize=14, loc = 6)
#     PlotSite = '../DataResults/Stats/SummarizingStats/Charts/StackedDualAxes/'
#     name = PlotSite + filenameForCharts + ".pdf"
#     traceuse.show(block=False)
#     traceuse.savefig(name, bbox_inches='tight')
#     traceuse.pause(0.5)
...
# # LaTexTopLevelOneStats = pd.read_csv('../DataResults/Stats/SummarizingStats/' + filenameForStats + '.csv')
# # TopLevelOneStats.to_latex('../DataResults/Stats/SummarizingStats/' + filenameForStats + '.tex', index = True)
# # print(TopLevelOneStats.to_latex('../DataResults/Stats/SummarizingStats/' + filenameForStats + '.tex', index = False))
#
# # Since sampling normality is essentially from a population that's normally distriuted, it's prudent to assume
# # normality as shown graphically and test-wise.
#
#         # random.seed(071919012422)
#         # if len(exp) == len(control):
#         #     do the independent sampling on exp and control
#         # elif len(exp) > len(control):
#         #     exp = random.sample(exp, len(control))
#         #     do the independent sampling on exp and control
#         # else control = random.sample(control, len(exp))
#         # do the independent sampling on exp and control
#
#
# # Bar Plot Stuff (OLD)
# sumH1ExperimentalConditionInterruptions = sum(H1ExperimentalConditionInterruptions)\
#                                           /len(H1ExperimentalConditionInterruptions)
# sumH1ControlConditionInterruptions = sum(H1ControlConditionInterruptions)\
#                                      /len(H1ControlConditionInterruptions)
# sumH1ExperimentalConditionResumptions = sum(H1ExperimentalConditionResumptions)\
#                                         /len(H1ExperimentalConditionResumptions)
# sumH1ControlConditionResumptions = sum(H1ControlConditionResumptions)\
#                                    /len(H1ControlConditionResumptions)
# sumH2ExperimentalConditionInterruptions = sum(H2ExperimentalConditionInterruptions)\
#                                           /len(H2ExperimentalConditionInterruptions)
# sumH2ControlConditionInterruptions = sum(H2ControlConditionInterruptions)\
#                                      /len(H2ControlConditionInterruptions)
# sumH2ExperimentalConditionResumptions = sum(H2ExperimentalConditionResumptions)\
#                                         /len(H2ExperimentalConditionResumptions)
# sumH2ControlConditionResumptions = sum(H2ControlConditionResumptions)\
#                                    /len(H2ControlConditionResumptions)
#
# filenameForBarPlots = "ExperimentalControlLagsJuxtaposed"
# # set width of bar
# barWidth = 0.375
# fig = traceuse.subplots(figsize=(12, 8))
#
# # set height of bar
# Comparison = [sumH1ControlConditionInterruptions,
#               sumH1ControlConditionResumptions,
#               sumH2ControlConditionInterruptions,
#               sumH2ControlConditionResumptions]
# Intervention = [sumH1ExperimentalConditionInterruptions,
#                 sumH1ExperimentalConditionResumptions,
#                 sumH2ExperimentalConditionInterruptions,
#                 sumH2ExperimentalConditionResumptions]
#
# # Set position of bars on X Axis
# controlBar = np.arange(len(Comparison))
# experimentalBar = [x + barWidth for x in controlBar]
#
# # Plot part of Either Lags' Stats on chart
# # H1InterConditionsInterruptionStats
# T, dof, pValue, timeSaved = round(H1InterConditionsInterruptionStats.iat[0, 1], 2), \
#                  H1InterConditionsInterruptionStats.iat[0, 2], \
#                  round(H1InterConditionsInterruptionStats.iat[0, 4], 2),\
#                  round(H1InterConditionsInterruptionStats.iat[0, 13], 2)
# if pValue < 0.001:
#     pValue = "< 0.001"
#     H1InterConditionsInterruptionStats = 't(' + str(dof) + ') = ' + str(T) + ', p ' + str(pValue)
# else:
#     H1InterConditionsInterruptionStats = 't('+str(dof)+') = '+str(T)+', p = ' +str(pValue)
# traceuse.text(-0.2, 7.9, "Intervention is Significant:", fontsize=9) # label is hardcoded, so check which condition and pvalue
# traceuse.text(-0.2, 7.5, H1InterConditionsInterruptionStats, fontsize=8, style='italic', fontweight='bold')
# traceuse.text(-0.2, 7.1, "Time Savings: " +str(abs(timeSaved))+ " Seconds" , fontsize=8, fontweight='bold')
#
# # H1InterConditionsResumptionStats
# T, dof, pValue, timeSaved = round(H1InterConditionsResumptionStats.iat[0, 1], 2), \
#                  H1InterConditionsResumptionStats.iat[0, 2], \
#                  round(H1InterConditionsResumptionStats.iat[0, 4], 2),\
#                  round(H1InterConditionsResumptionStats.iat[0, 13], 2)
# if pValue < 0.001:
#     pValue = "< 0.001"
#     H1InterConditionsResumptionStats = 't(' + str(dof) + ') = ' + str(T) + ', p ' + str(pValue)
# else:
#     H1InterConditionsResumptionStats = 't('+str(dof)+') = '+str(T)+', p = ' +str(pValue)
# traceuse.text(0.82, 9.8, "Non-Significance:", fontsize=9) # label is hardcoded, so check which condition and pvalue
# traceuse.text(0.82, 9.4, H1InterConditionsResumptionStats, fontsize=8, style='italic', fontweight='bold')
# traceuse.text(0.82, 9.0, "Time Savings: " +str(abs(timeSaved))+ " Seconds" , fontsize=8, fontweight='bold')
#
# # H2InterConditionsInterruptionStats
# T, dof, pValue, timeSaved = round(H2InterConditionsInterruptionStats.iat[0, 1], 2), \
#                  H2InterConditionsInterruptionStats.iat[0, 2], \
#                  round(H2InterConditionsInterruptionStats.iat[0, 4], 2),\
#                  round(H2InterConditionsInterruptionStats.iat[0, 13], 2)
# if pValue < 0.001:
#     pValue = "< 0.001"
#     H2InterConditionsInterruptionStats = 't(' + str(dof) + ') = ' + str(T) + ', p ' + str(pValue)
# else:
#     H2InterConditionsInterruptionStats = 't('+str(dof)+') = '+str(T)+', p = ' +str(pValue)
# traceuse.text(1.82, 8.2, "Comparison is Significant:", fontsize=9) # label is hardcoded, so check which condition and pvalue
# traceuse.text(1.82, 7.8, H2InterConditionsInterruptionStats, fontsize=8, style='italic', fontweight='bold')
# traceuse.text(1.82, 7.4, "Time Savings: " +str(abs(timeSaved))+ " Seconds" , fontsize=8, fontweight='bold')
#
# # H2InterConditionsResumptionStats
# T, dof, pValue, timeSaved = round(H2InterConditionsResumptionStats.iat[0, 1], 2), \
#                  H2InterConditionsResumptionStats.iat[0, 2], \
#                  round(H2InterConditionsResumptionStats.iat[0, 4], 2),\
#                  round(H2InterConditionsResumptionStats.iat[0, 13], 2)
# if pValue < 0.001:
#     pValue = "< 0.001"
#     H2InterConditionsResumptionStats = 't(' + str(dof) + ') = ' + str(T) + ', p ' + str(pValue)
# else:
#     H2InterConditionsResumptionStats = 't('+str(dof)+') = '+str(T)+', p = ' +str(pValue)
# traceuse.text(2.82, 14.6, "Comparison is Significant:", fontsize=9) # label is hardcoded, so check which condition and pvalue
# traceuse.text(2.82, 14.2, H2InterConditionsResumptionStats, fontsize=8, style='italic', fontweight='bold')
# traceuse.text(2.82, 13.8, "Time Savings: " +str(abs(timeSaved))+ " Seconds" , fontsize=8, fontweight='bold')
#
# # Make the plot
# traceuse.bar(experimentalBar, Intervention, color='g', width=barWidth,
#         edgecolor='grey', label='Experimental Intervention')
# traceuse.bar(controlBar, Comparison, color='b', width=barWidth,
#         edgecolor='grey', label='Control Comparison')
#
# traceuse.xlabel('Performance Metrics by Hypotheses', fontweight='bold', fontsize=15)
# traceuse.ylabel('Average Lag Times (Seconds)', fontweight='bold', fontsize=15)
# traceuse.xticks([r + barWidth for r in range(len(Comparison))],
#            ['Hypothesis 1: Interruption Lag                    ',
#             'Hypothesis 1: Resumption Lag                    ',
#             'Hypothesis 2: Interruption Lag                    ',
#             'Hypothesis 2: Resumption Lag               '])
#
# traceuse.legend(fontsize=12, loc = 2)
# name = PlotPlace + filenameForBarPlots + ".pdf"
# traceuse.savefig(name, bbox_inches='tight')
# traceuse.show(block=False)
# traceuse.pause(.5)
# traceuse.close("all")
#
#
# # Bar Plot Stuff (Newer)
# AVGfirst8averageExperimentalInterventionAttentionsAssessment =\
#     sum(first8averageExperimentalInterventionAttentionsAssessment)/\
#     len(first8averageExperimentalInterventionAttentionsAssessment)
# AVGlast8averageExperimentalInterventionAttentionsTesting = \
#     sum(last8averageExperimentalInterventionAttentionsTesting)/\
#     len(last8averageExperimentalInterventionAttentionsTesting)
#
# AVGfirst8averageExperimentalInterventionResumptionsAssessment = \
#     sum(first8averageExperimentalInterventionResumptionsAssessment)/\
#     len(first8averageExperimentalInterventionResumptionsAssessment)
# AVGlast8averageExperimentalInterventionResumptionsTesting = \
#     sum(last8averageExperimentalInterventionResumptionsTesting)/\
#     len(last8averageExperimentalInterventionResumptionsTesting)
#
# AVGfirst16averageExperimentalInterventionAccuraciesAssessment = \
#     sum(first16averageExperimentalInterventionAccuraciesAssessment)/\
#     len(first16averageExperimentalInterventionAccuraciesAssessment)
# AVGlast16averageExperimentalInterventionAccuraciesTesting = \
#     sum(last16averageExperimentalInterventionAccuraciesTesting)/\
#     len(last16averageExperimentalInterventionAccuraciesTesting)
#
# AVGfirst16averageExperimentalInterventionSpeedsAssessment = \
#     sum(first16averageExperimentalInterventionSpeedsAssessment)/\
#     len(first16averageExperimentalInterventionSpeedsAssessment)
# AVGlast16averageExperimentalInterventionSpeedsTesting = \
#     sum(last16averageExperimentalInterventionSpeedsTesting)/\
#     len(last16averageExperimentalInterventionSpeedsTesting)
#
# AVGfirst8averageControlComparisonAttentionsAssessment = \
#     sum(first8averageControlComparisonAttentionsAssessment)/\
#     len(first8averageControlComparisonAttentionsAssessment)
# AVGlast8averageControlComparisonAttentionsTesting = \
#     sum(last8averageControlComparisonAttentionsTesting)/\
#     len(last8averageControlComparisonAttentionsTesting)
#
# AVGfirst8averageControlComparisonResumptionsAssessment = \
#     sum(first8averageControlComparisonResumptionsAssessment)/\
#     len(first8averageControlComparisonResumptionsAssessment)
# AVGlast8averageControlComparisonResumptionsTesting = \
#     sum(last8averageControlComparisonResumptionsTesting)/\
#     len(last8averageControlComparisonResumptionsTesting)
#
# AVGfirst16averageControlComparisonAccuraciesAssessment = \
#     sum(first16averageControlComparisonAccuraciesAssessment)/\
#     len(first16averageControlComparisonAccuraciesAssessment)
# AVGlast16averageControlComparisonAccuraciesTesting = \
#     sum(last16averageControlComparisonAccuraciesTesting)/\
#     len(last16averageControlComparisonAccuraciesTesting)
#
# AVGfirst16averageControlComparisonSpeedsAssessment = \
#     sum(first16averageControlComparisonSpeedsAssessment)/\
#     len(first16averageControlComparisonSpeedsAssessment)
# AVGlast16averageControlComparisonSpeedsTesting = \
#     sum(last16averageControlComparisonSpeedsTesting)/\
#     len(last16averageControlComparisonSpeedsTesting)
#
# filenameForBarPlots = "AssessmentTestingMetricsJuxtaposed"
# # set width of bar
# barWidth = 0.375
# fig = traceuse.subplots(figsize=(16, 8))
#
# # set height of bar
# Assessment = [AVGfirst8averageExperimentalInterventionAttentionsAssessment,
#               AVGfirst8averageExperimentalInterventionResumptionsAssessment,
#               AVGfirst16averageExperimentalInterventionAccuraciesAssessment,
#               AVGfirst16averageExperimentalInterventionSpeedsAssessment,
#               AVGfirst8averageControlComparisonAttentionsAssessment,
...
#               AVGfirst16averageControlComparisonAccuraciesAssessment,
#               AVGfirst16averageControlComparisonSpeedsAssessment]
# Testing = [AVGlast8averageExperimentalInterventionAttentionsTesting,
#            AVGlast8averageExperimentalInterventionResumptionsTesting,
#            AVGlast16averageExperimentalInterventionAccuraciesTesting,
#            AVGlast16averageExperimentalInterventionSpeedsTesting,
#            AVGlast8averageControlComparisonAttentionsTesting,
...
#
# # Set position of bars on X Axis
# assessmentBar = np.arange(len(Assessment))
# testingBar = [x + barWidth for x in assessmentBar]
#
# # Plot part of Either Lags' Stats on chart
# # H1InterConditionsInterruptionStats
# # T, dof, pValue, timeSaved = round(H1InterConditionsInterruptionStats.iat[0, 1], 2), \
...
#
# # Make the plot
# traceuse.bar(assessmentBar, Assessment, color='blue', width=barWidth,
#         edgecolor='grey', label='Assessment')
# traceuse.bar(testingBar, Testing, color='green', width=barWidth,
#         edgecolor='grey', label='Testing')
#
#
# traceuse.xlabel('Performance Metrics between Assessment and Testing', fontweight='bold', fontsize=15)
# traceuse.ylabel('Average Lag Times (Seconds)', fontweight='bold', fontsize=15)
# traceuse.xticks([r + barWidth/2 for r in range(len(Assessment))],
#                 ['Exp: Interruption Lag',
#                  '   Exp: Resumption Lag',
#                  '   Exp: Accuracy',
#                  'Exp: Speed',
#                  'Control: Interruption Lag',
#                  '             Control: Resumption Lag',
#                  '                 Control: Accuracy',
#                  '             Control: Speed'])
#
# traceuse.legend(fontsize=12, loc = 2)
...
#
#
# # BoxPlot Function Calls
# # Resumption Lag BTW Conditions
# leftSubTitleText = "Experimental"
# rightSubTitleText = "Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Conditions"
# nameOfMetric = "Resumption Lag"
# filenameForCharts = "ResumptionLagBTWEXPandCON"
#
# boxPlotter(ExperimentalInterventionResumptionLagsAssessment,
#            ExperimentalInterventionResumptionLagsTesting,
#            ControlComparisonResumptionLagsAssessment,
#            ControlComparisonResumptionLagsTesting,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Interruption Lag BTW Conditions
# leftSubTitleText = "Experimental"
# rightSubTitleText = "Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Conditions"
# nameOfMetric = "Interruption Lag"
# filenameForCharts = "InterruptionLagBTWEXPandCON"
#
# boxPlotter(ExperimentalInterventionInterruptionLagsAssessment,
#            ExperimentalInterventionInterruptionLagsTesting,
#            ControlComparisonInterruptionLagsAssessment,
#            ControlComparisonInterruptionLagsTesting,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Accuracy BTW Conditions
# leftSubTitleText = "Experimental"
# rightSubTitleText = "Control"
# yAxisText = 'Error Reduction (Percentage)'
# xAxisText = "Conditions"
# nameOfMetric = "Accuracy"
# filenameForCharts = "AccuracyBTWEXPandCON"
#
# boxPlotter(ExperimentalInterventionAccuraciesAssessment,
#            ExperimentalInterventionAccuraciesTesting,
#            ControlComparisonAccuraciesAssessment,
#            ControlComparisonAccuraciesTesting,
#            leftSubTitleText,
...
# xAxisText = "Conditions"
# nameOfMetric = "Speed"
# filenameForCharts = "SpeedBTWEXPandCON"
#
# boxPlotter(ExperimentalInterventionSpeedAssessment,
#            ExperimentalInterventionSpeedTesting,
#            ControlComparisonSpeedTesting,
#            ControlComparisonSpeedTesting,
#            leftSubTitleText,
...
# # H2 by Conditions
#
# # Resumption Lag BTW H2 Conditions
# leftSubTitleText = "H2 of Experimental"
# rightSubTitleText = "H2 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H2 of Conditions"
# nameOfMetric = "Resumption Lag"
# filenameForCharts = "ResumptionLagBTWH2ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionResumptionLagsAssessmentH2,
#            ExperimentalInterventionResumptionLagsTestingH2,
#            ControlComparisonResumptionLagsAssessmentH2,
#            ControlComparisonResumptionLagsTestingH2,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Interruptions Lag BTW H2 Conditions
# leftSubTitleText = "H2 of Experimental"
# rightSubTitleText = "H2 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H2 of Conditions"
# nameOfMetric = "Interruptions Lag"
# filenameForCharts = "InterruptionLagBTWH2ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionInterruptionLagsAssessmentH2,
#            ExperimentalInterventionInterruptionLagsTestingH2,
#            ControlComparisonInterruptionLagsAssessmentH2,
#            ControlComparisonInterruptionLagsTestingH2,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Accuracy BTW H2 of Conditions
# leftSubTitleText = "H2 of Experimental"
# rightSubTitleText = "H2 of Control"
# yAxisText = 'Error Reduction (Percentage)'
# xAxisText = "H2 of Conditions"
# nameOfMetric = "Accuracy"
# filenameForCharts = "AccuracyBTWH2EXPandCON"
#
# boxPlotter(ExperimentalInterventionAccuraciesAssessmentH2,
#            ExperimentalInterventionAccuraciesTestingH2,
#            ControlComparisonAccuraciesAssessmentH2,
#            ControlComparisonAccuraciesTestingH2,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Speed BTW H2 Conditions
# leftSubTitleText = "H2 of Experimental"
# rightSubTitleText = "H2 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H2 of Conditions"
# nameOfMetric = "Speed"
# filenameForCharts = "SpeedBTWH2ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionSpeedAssessmentH2,
#            ExperimentalInterventionSpeedTestingH2,
#            ControlComparisonSpeedAssessmentH2,
#            ControlComparisonSpeedTestingH2,
#            leftSubTitleText,
...
# # H1 by Conditions
#
# # Resumption Lag BTW H1 Conditions
# leftSubTitleText = "H1 of Experimental"
# rightSubTitleText = "H1 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H1 of Conditions"
# nameOfMetric = "Resumption Lag"
# filenameForCharts = "ResumptionLagBTWH1ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionResumptionLagsAssessmentH1,
#            ExperimentalInterventionResumptionLagsTestingH1,
#            ControlComparisonResumptionLagsAssessmentH1,
#            ControlComparisonResumptionLagsTestingH1,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Interruptions Lag BTW H1 Conditions
# leftSubTitleText = "H1 of Experimental"
# rightSubTitleText = "H1 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H1 of Conditions"
# nameOfMetric = "Interruptions Lag"
# filenameForCharts = "InterruptionLagBTWH1ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionInterruptionLagsAssessmentH1,
#            ExperimentalInterventionInterruptionLagsTestingH1,
#            ControlComparisonInterruptionLagsAssessmentH1,
#            ControlComparisonInterruptionLagsTestingH1,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Accuracy BTW H1 of Conditions
# leftSubTitleText = "H1 of Experimental"
# rightSubTitleText = "H1 of Control"
# yAxisText = 'Error Reduction (Percentage)'
# xAxisText = "H1 of Conditions"
# nameOfMetric = "Accuracy"
# filenameForCharts = "AccuracyBTWH1EXPandCON"
#
# boxPlotter(ExperimentalInterventionAccuraciesAssessmentH1,
#            ExperimentalInterventionAccuraciesTestingH1,
#            ControlComparisonAccuraciesAssessmentH1,
#            ControlComparisonAccuraciesTestingH1,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Speed BTW H1 Conditions
# leftSubTitleText = "H1 of Experimental"
# rightSubTitleText = "H1 of Control"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "H1 of Conditions"
# nameOfMetric = "Speed"
# filenameForCharts = "SpeedBTWH1ofEXPandCON"
#
# boxPlotter(ExperimentalInterventionSpeedAssessmentH1,
#            ExperimentalInterventionSpeedTestingH1,
#            ControlComparisonSpeedAssessmentH1,
#            ControlComparisonSpeedTestingH1,
#            leftSubTitleText,
...
#
# # -----------------------------------------------------
# # Task Types within Same Conditions
#
# # Resumption Lag BTW Task Types within Experimental Condition
# leftSubTitleText = "Path Tracing"
# rightSubTitleText = "Tower of Hanoi"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Task Types within Experimental"
# nameOfMetric = "Resumption Lag"
# filenameForCharts = "ResumptionLagBTWTaskTypeWithinEXP"
#
# boxPlotter(ExperimentalInterventionResumptionLagsAssessmentPathTracing,
#            ExperimentalInterventionResumptionLagsTestingPathTracing,
#            ExperimentalInterventionResumptionLagsAssessmentToH,
#            ExperimentalInterventionResumptionLagsTestingToH,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # # Interruptions Lag BTW Task Types within Experimental Condition
# leftSubTitleText = "During Path Tracing"
# rightSubTitleText = "During Tower of Hanoi"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Task Types within Experimental"
# nameOfMetric = "Interruption Lag"
# filenameForCharts = "InterruptionLagBTWTaskTypeWithinEXP"
# #
# boxPlotter(ExperimentalInterventionInterruptionLagsAssessmentPathTracing,
#            ExperimentalInterventionInterruptionLagsTestingPathTracing,
#            ExperimentalInterventionInterruptionLagsAssessmentToH,
#            ExperimentalInterventionInterruptionLagsTestingToH,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Accuracy BTW Task Types within Experimental Condition
# leftSubTitleText = "Path Tracing"
# rightSubTitleText = "Tower of Hanoi"
# yAxisText = 'Error Reduction (Percentage)'
# xAxisText = "Task Types within Experimental"
# nameOfMetric = "Accuracy"
# filenameForCharts = "AccuracyBTWTaskTypeWithinEXP"
#
# boxPlotter(ExperimentalInterventionAccuraciesAssessmentPathTracing,
#            ExperimentalInterventionAccuraciesTestingPathTracing,
#            ExperimentalInterventionAccuraciesAssessmentToH,
#            ExperimentalInterventionAccuraciesTestingToH,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # # Speed BTW Task Types within Experimental Condition
# leftSubTitleText = "Path Tracing"
# rightSubTitleText = "Tower of Hanoi"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Task Types within Experimental"
# nameOfMetric = "Speed"
# filenameForCharts = "SpeedBTWTaskTypeWithinEXP"
#
# boxPlotter(ExperimentalInterventionSpeedAssessmentPathTracing,
#            ExperimentalInterventionSpeedTestingPathTracing,
#            ExperimentalInterventionSpeedAssessmentToH,
#            ExperimentalInterventionSpeedTestingToH,
#            leftSubTitleText,
...
# # Task Types within Same Conditions
#
# # Resumption Lag BTW Task Types within Control Condition
# leftSubTitleText = "Path Tracing"
# rightSubTitleText = "Tower of Hanoi"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Task Types within Control"
# nameOfMetric = "Resumption Lag"
# filenameForCharts = "ResumptionLagBTWTaskTypeWithinCON"
#
# boxPlotter(ControlComparisonResumptionLagsAssessmentPathTracing,
#            ControlComparisonResumptionLagsTestingPathTracing,
#            ControlComparisonResumptionLagsAssessmentToH,
#            ControlComparisonResumptionLagsTestingToH,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Interruption Lag BTW Task Types within Control Condition
# leftSubTitleText = "During Path Tracing"
# rightSubTitleText = "During Tower of Hanoi"
# yAxisText = 'Average Change (Seconds)'
# xAxisText = "Task Types within Control"
# nameOfMetric = "Interruption Lag"
# filenameForCharts = "InterruptionLagBTWTaskTypeWithinCON"
#
# boxPlotter(ControlComparisonInterruptionLagsAssessmentPathTracing,
#            ControlComparisonInterruptionLagsTestingPathTracing,
#            ControlComparisonInterruptionLagsAssessmentToH,
#            ControlComparisonInterruptionLagsTestingToH,
#            leftSubTitleText,
...
#            filenameForCharts)
#
# # Accuracy BTW Task Types within Control Condition
# leftSubTitleText = "Path Tracing"
# rightSubTitleText = "Tower of Hanoi"
# yAxisText = 'Error Reduction (Percentage)'
# xAxisText = "Task Types within Control"
# nameOfMetric = "Accuracy"
# filenameForCharts = "AccuracyBTWTaskTypeWithinCON"
#
# boxPlotter(ControlComparisonAccuraciesAssessmentPathTracing,
#            ControlComparisonAccuraciesTestingPathTracing,
#            ControlComparisonAccuraciesAssessmentToH,
#            ControlComparisonAccuraciesTestingToH,
#            leftSubTitleText,
...
# xAxisText = "Task Types within Control"
# nameOfMetric = "Speed"
# filenameForCharts = "SpeedBTWTaskTypeWithinCON"
#
# boxPlotter(ControlComparisonSpeedAssessmentPathTracing,
#            ControlComparisonSpeedTestingPathTracing,
#            ControlComparisonSpeedAssessmentToH,
#            ControlComparisonSpeedTestingToH,
#            leftSubTitleText,
...
#
#
# # Bar plotter function calls
# leftSubTitleText = "Supportive"
# rightSubTitleText = "Alternative"
# xAxisText = "by Conditions"
# # xAxisText = "n.s."
# filenameForCharts = "AnalysesMetricsConditions"
#
# barPlotter(ExperimentalInterventionResumptionLags,
#            ControlComparisonResumptionLags,
#            ExperimentalInterventionInterruptionLags,
#            ControlComparisonInterruptionLags,
#            ExperimentalInterventionAccuracies,
...
# leftSubTitleText = "Supportive"
# rightSubTitleText = "Alternative"
# xAxisText = "by Conditions (Hypothesis 1)"
# filenameForCharts = "AnalysesMetricsHypothesis1"
#
# barPlotter(H1ExperimentalInterventionResumptionLags,
#            H1ControlComparisonResumptionLags,
#            H1ExperimentalInterventionInterruptionLags,
#            H1ControlComparisonInterruptionLags,
#            H1ExperimentalInterventionAccuracies,
...
# leftSubTitleText = "Supportive"
# rightSubTitleText = "Alternative"
# xAxisText = "by Conditions (Hypothesis 2)"
# filenameForCharts = "AnalysesMetricsHypothesis2"
#
# barPlotter(H2ExperimentalInterventionResumptionLags,
#            H2ControlComparisonResumptionLags,
#            H2ExperimentalInterventionInterruptionLags,
#            H2ControlComparisonInterruptionLags,
#            H2ExperimentalInterventionAccuracies,
...
#
# leftSubTitleText = "Path-Tracing"
# rightSubTitleText = "Tower (Hanoi)"
# xAxisText = "by Task Types (Experimental)"
# filenameForCharts = "AnalysesMetricsTaskTypeEXP"
#
# barPlotter(PathTracingExperimentalInterventionResumptionLags,
#            ToHExperimentalInterventionResumptionLags,
#            PathTracingExperimentalInterventionInterruptionLags,
#            ToHExperimentalInterventionInterruptionLags,
#            PathTracingExperimentalInterventionAccuracies,
...
# leftSubTitleText = "Path-Tracing"
# rightSubTitleText = "Tower (Hanoi)"
# xAxisText = "by Task Types (Control)"
# filenameForCharts = "AnalysesMetricsTaskTypeCON"
#
# barPlotter(PathTracingControlComparisonResumptionLags,
#            ToHControlComparisonResumptionLags,
#            PathTracingControlComparisonInterruptionLags,
#            ToHControlComparisonInterruptionLags,
#            PathTracingControlComparisonAccuracies,
...
#
#
# leftSubTitleText = "Pre-Intervention"
# rightSubTitleText = "Post-Intervention"
# xAxisText = "Between Phases (Hypothesis 2)"
# filenameForCharts = "PerformanceMetricsPhasesH1"
#
# barPlotterAT(RLH1EXPplusCONStats,
#            RLH1EXPplusCONStats,
#            ILH1EXPplusCONStats,
#            ILH1EXPplusCONStats,
#            ACH1EXPplusCONStats,
...
# leftSubTitleText = "Pre-Intervention"
# rightSubTitleText = "Post-Intervention"
# xAxisText = "Between Phases (Hypothesis 3)"
# filenameForCharts = "PerformanceMetricsPhasesH2"
#
# barPlotterAT(RLH2EXPplusCONStats,
#            RLH2EXPplusCONStats,
#            ILH2EXPplusCONStats,
#            ILH2EXPplusCONStats,
#            ACH2EXPplusCONStats,
...
# rightSubTitleText = "Alternative"
# xAxisText = "n.s. "
# filenameForCharts = "AnalysesMetricsConditionsStripped"
#
# barPlotterAT(ExperimentalInterventionResumptionLags,
#            ControlComparisonResumptionLags,
#            ExperimentalInterventionInterruptionLags,
#            ControlComparisonInterruptionLags,
#            ExperimentalInterventionAccuracies,
...
# rightSubTitleText = "Alternative"
# # xAxisText = "by Conditions"
# xAxisText = "Between Conditions (Hypothesis 3)"
# # xAxisText = "n.s."
# filenameForCharts = "AnalysesMetricsConditionsH3Dual"
#
# barPlotterDualAxes(ExperimentalInterventionResumptionLags,
#            ControlComparisonResumptionLags,
#            ExperimentalInterventionInterruptionLags,
#            ControlComparisonInterruptionLags,
#            ExperimentalInterventionAccuracies,
...
# filenameForCharts = "AnalysesMetricsConditionsH3Dual"
#
# barPlotterDualAxes(InterConditionsResumptionStats,
#            InterConditionsResumptionStats,
#            InterConditionsInterruptionStats,
#            InterConditionsInterruptionStats,
#            InterConditionsAccuracyStats,
...
# leftSubTitleText = "Pre-Intervention"
# rightSubTitleText = "Post-Intervention"
# # xAxisText = "Between Phases (Hypothesis 1)"
# xAxisText = "Between Phases (Novel Tasks)"
# filenameForCharts = "PerformanceMetricsPhasesH1Dual"
#
# barPlotterDualAxes(RLH1EXPplusCONStats,
#            RLH1EXPplusCONStats,
#            ILH1EXPplusCONStats,
#            ILH1EXPplusCONStats,
#            ACH1EXPplusCONStats,
...
# rightSubTitleText = "Post-Intervention"
# xAxisText = "Between Phases (Hypothesis 2)"
# xAxisText = "Between Phases (Novel Interruptions)"
# filenameForCharts = "PerformanceMetricsPhasesH2Dual"
#
# barPlotterDualAxes(RLH2EXPplusCONStats,
#            RLH2EXPplusCONStats,
#            ILH2EXPplusCONStats,
#            ILH2EXPplusCONStats,
#            ACH2EXPplusCONStats,
...
# leftSubTitleText = "Pre-Intervention"
# rightSubTitleText = "Post-Intervention"
# xAxisText = "Between Phases (Hypothesis 1-1)"
# xAxisText = "Between Phases (Novel Tasks)"
# # filenameForCharts = "PerformanceMetricsPhasesH1-1DualStacked"
# filenameForCharts = "PerformanceMetricsPhasesH1DualStackedErrorBars"
#
# barPlotterStackedDualAxes(
#     RLH1EXPplusCONStats,
#     RLH1EXPplusCONStats,
#     ILH1EXPplusCONStats,
#     ILH1EXPplusCONStats,
...
# leftSubTitleText = "Pre-Intervention"
# rightSubTitleText = "Post-Intervention"
# xAxisText = "Between Phases (Hypothesis 1-2)"
# xAxisText = "Between Phases (Novel Interruptions)"
# # filenameForCharts = "PerformanceMetricsPhasesH1-2DualStacked"
# filenameForCharts = "PerformanceMetricsPhasesH2DualStackedErrorBars"
#
# barPlotterStackedDualAxes(
#     RLH2EXPplusCONStats,
#     RLH2EXPplusCONStats,
...
# rightSubTitleText = "Alternative"
# xAxisText = "by Conditions"
# xAxisText = "Between Conditions (Hypothesis 2)"
# # xAxisText = "n.s."
# filenameForCharts = "AnalysesMetricsConditionsH2DualStackedErrorBars"
#
# barPlotterStackedDualAxes(
#     InterConditionsResumptionStats,
#     InterConditionsResumptionStats,
...
#
#
# # String together all assessment of RL, IL, AC, and SP in H1, then Test.
# # Then do the same for H2
#
# # PTTDiffResumeAssess = ExperimentalInterventionResumptionLagsAssessmentPathTracing+ControlComparisonResumptionLagsAssessmentPathTracing
# # PTTDiffResumeTest = ExperimentalInterventionResumptionLagsTestingPathTracing+ControlComparisonResumptionLagsTestingPathTracing
# # differenceBtwAssessNTestPTTResume = [sumAssess - sumTest for (sumAssess, sumTest) in zip(PTTDiffResumeAssess, PTTDiffResumeTest)]
# # print("differenceBtwAssessNTestPTTResume: ", differenceBtwAssessNTestPTTResume)
# # print("Length differenceBtwAssessNTestPTTResume: ", len(differenceBtwAssessNTestPTTResume))
# #
# # ToHDiffResumeAssess = ExperimentalInterventionResumptionLagsAssessmentToH+ControlComparisonResumptionLagsAssessmentToH
# # ToHDiffResumeTest = ExperimentalInterventionResumptionLagsTestingToH+ControlComparisonResumptionLagsTestingToH
# # differenceBtwAssessNTestToHResume = [sumAssess - sumTest for (sumAssess, sumTest) in zip(ToHDiffResumeAssess, ToHDiffResumeTest)]
# # print("differenceBtwAssessNTestToHResume: ", differenceBtwAssessNTestToHResume)
# # print("Length differenceBtwAssessNTestToHResume: ", len(differenceBtwAssessNTestToHResume))
# #
# # PTTDiffAttendAssess = ExperimentalInterventionInterruptionLagsAssessmentPathTracing+ControlComparisonInterruptionLagsAssessmentPathTracing
# # PTTDiffAttendTest = ExperimentalInterventionInterruptionLagsTestingPathTracing+ControlComparisonInterruptionLagsTestingPathTracing
# # differenceBtwAssessNTestPTTAttend = [sumAssess - sumTest for (sumAssess, sumTest) in zip(PTTDiffAttendAssess, PTTDiffAttendTest)]
